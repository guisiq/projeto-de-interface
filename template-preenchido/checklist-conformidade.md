# Checklist de Conformidade — Projeto UniAchados

## Requisitos Obrigatórios do Trabalho

| # | Requisito | Status | Onde está |
|---|---|---|---|
| 1 | Problema real e justificativa | ✅ | Seção 2 |
| 2 | Benchmarking com 3 sistemas/apps reais | ✅ | Seção 3 |
| 3 | 3 personas definidas | ✅ | Seção 4 |
...
|---|---|
| Nomes e matrículas dos alunos | Preencher no cabeçalho |
| Link do Figma | Inserir após criação do protótipo |
| Prints de tela do benchmarking | Capturar e inserir |
| Imagens dos wireframes | Criar no Figma/papel e inserir |
| Prints das telas finais | Exportar do Figma e inserir |
| Prints com marcações das heurísticas | Anotar sobre os prints exportados |
